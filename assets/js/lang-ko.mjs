export default {
  ...
  "scene2-desc-line1-em": "흐름을 끊지 않도록",
  "scene2-desc-line1-rest": ".",
  "scene2-desc-line1-prefix": "빌드를 기다리느라 ",
  "scene2-desc-line2-prefix": "코딩, 반영, 디버깅이 하나의 ",
  "scene2-desc-line2-em": "빠른 루프",
  "scene2-desc-line2-rest": "로 이어지는 개발을 지향합니다.",
  "scene2-flow-left-label": "일반 개발",
  "scene2-flow-right-label": "byeol",
  "scene2-flow-left-step1": "코드 작성",
  "scene2-flow-left-step2": "빌드",
  "scene2-flow-left-step3": "대기",
  "scene2-flow-left-step4": "실행",
  "scene2-flow-left-step5": "디버깅",
  "scene2-flow-right-step1": "코드 작성",
  "scene2-flow-right-step2": "바로 확인",
  "scene2-flow-right-step3": "계속 수정",
  "scene2-flow-right-step4": "흐름 유지",
  "scene3-kicker": "실행 전에 위험을 읽어내도록",
  "scene3-title-line1": "스크립트처럼 가볍게,",
  "scene3-title-line2": "오류는 먼저",
  "scene3-desc-line1-prefix": "빠르게 시작할 수 있는 ",
  "scene3-desc-line1-em": "스크립트 언어",
  "scene3-desc-line1-rest": "이지만,",
  "scene3-desc-line2-prefix": "실수는 실행 전에 최대한 먼저 잡아내는 ",
  "scene3-desc-line2-em": "정적 검사",
  ...
  "download-title": "byeol 다운로드",
  "download-desc": "사용 중인 환경에 맞는 빌드를 선택하세요.",
  "download-auto": "내 기기에 맞춰 다운로드",
  "download-guide-label": "사용법을 배워보세요.",
  "download-guide-link": "가이드로 이동",
  "windows": "윈도우",
  "ubuntu": "우분투",
  "mac": "맥",
