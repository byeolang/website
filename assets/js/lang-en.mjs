export default {
  ...
  "scene2-desc-line1": "Keep the flow moving instead of stopping for every build.",
  "scene2-desc-line2": "byeol aims for a fast loop where coding, feedback, and debugging stay connected.",
